...
const projects: Project[] = [
  ...
  },
  {
    num: "02",
    name: {
      fr: "Portfolio V2 — Bureau 3D",
      en: "Portfolio V2 — 3D Desk Scene",
      de: "Portfolio V2 — 3D-Schreibtisch",
      zh: "Portfolio V2 — 3D 桌面场景",
    },
    stack: [
      "Three.js",
      "JavaScript",
    ...
    desc: {
      fr: "Portfolio immersif avec un bureau 3D interactif — cliquer pour entrer dans la scène et accéder à l'OS portfolio.",
      en: "Immersive portfolio with an interactive 3D desk — click to enter the scene and access the OS portfolio.",
      de: "Immersives Portfolio mit interaktivem 3D-Schreibtisch — klicken, um die Szene zu betreten und auf das OS-Portfolio zuzugreifen.",
      zh: "沉浸式 3D 桌面场景作品集——点击进入场景，访问 OS 风格作品集。",
    },
    details: {
      fr: "Deuxième version du portfolio personnel. Scène 3D d'un bureau rétro construite avec Three.js et rendue dans le navigateur. Au clic, la caméra zoome vers l'écran de l'ordinateur pour afficher le portfolio OS (portfolio-inner-site) intégré via un iframe rendu avec le CSS Renderer de Three.js. Assets bundlés avec Webpack 5, déployé sur GitHub Pages.",
      en: "Second version of the personal portfolio. 3D retro desk scene built with Three.js and rendered in the browser. On click, the camera zooms into the monitor screen to reveal the OS portfolio (portfolio-inner-site) embedded via an iframe rendered with Three.js CSS Renderer. Assets bundled with Webpack 5, deployed on GitHub Pages.",
      de: "Zweite Version des persönlichen Portfolios. 3D-Retro-Schreibtisch-Szene mit Three.js und Webpack. Beim Klicken zoomt die Kamera in den Bildschirm, um das OS-Portfolio (portfolio-inner-site) via Three.js CSS Renderer einzubetten. Webpack 5, GitHub Pages.",
      zh: "第二版个人作品集，Three.js 构建的复古 3D 桌面场景，点击后摄像机推进至显示器，通过 Three.js CSS Renderer 嵌入 OS 风格作品集。Webpack 5 打包，部署于 GitHub Pages。",
    },
    url: "https://notsostoney.github.io/portfolio-v2/",
    github: "https://github.com/notsostoney/portfolio-v2",
    media: [],
